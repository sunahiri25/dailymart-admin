...
export default function AdminsPage() {
    ...
    return (
        <Layout>
            <Link className="bg-blue-900 text-white py-1 px-2 rounded-md " href={'/staffs/new'}>
                Add new staff
            </Link>
            <h1 className="mt-2">Number of staffs: {staffs.length}</h1>
                ...
                <tbody>
                    {staffs.length > 0 && staffs.map(staff => (
                        <tr key={staff._id}>
                            ...
                            <td>{staff.email}</td>
                            <td>
                                <Link href={'/staffs/edit/' + staff._id}>
                                ...
                                <Link href={'/staffs/delete/' + staff._id}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" data-slot="icon" className="w-4 h-4">
